 ...
 */
 (function() {
	 ...
	 function initEvents() {
		...
		[].slice.call(proximo).forEach(function(item, pos) {
			item.addEventListener('click', function(ev) {
				...
				current = pos;
				//alterar o numero, mesmo numero para posts/jobs
				if(current !== 9) {
					//console.log(current);
					//console.log('frente / pos: '+pos+ ' current: '+current)
	...
	function hideContent() {
		...
		classie.removeClass(contentItem, 'content__item--show');
		classie.removeClass(contentItemsContainer, 'content--show');
		classie.removeClass(closeCtrl, 'close-button--show');
		classie.removeClass(bodyEl, 'view-single');
